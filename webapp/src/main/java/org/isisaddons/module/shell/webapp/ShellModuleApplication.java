 ...
 *  under the License.
 */
package org.isisaddons.module.shell.webapp;
 ...
 * 
 */
public class ShellModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "Shell Module Example App";
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                // bind(AppManifest.class).toInstance(new ShellAppAppManifest());
            }
        };
