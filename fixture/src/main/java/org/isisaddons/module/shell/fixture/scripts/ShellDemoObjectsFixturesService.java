 ...
 *  under the License.
 */
package org.isisaddons.module.shell.fixture.scripts;
...
public class ShellDemoObjectsFixturesService extends FixtureScripts {

    public ShellDemoObjectsFixturesService() {
        super(ShellDemoObjectsFixturesService.class.getPackage().getName());
    }
    ...
    public Object installFixturesAndReturnFirst() {
        final FixtureScript script = findFixtureScriptFor(ShellDemoObjectsFixture.class);
